...
const (
	AuthorService_GetAuthor_FullMethodName            = "/api.profile.v1.AuthorService/GetAuthor"
	AuthorService_GetAuthorByProfileID_FullMethodName = "/api.profile.v1.AuthorService/GetAuthorByProfileID"
	AuthorService_ListAuthors_FullMethodName          = "/api.profile.v1.AuthorService/ListAuthors"
	AuthorService_CreateAuthor_FullMethodName         = "/api.profile.v1.AuthorService/CreateAuthor"
	AuthorService_UpdateAuthor_FullMethodName         = "/api.profile.v1.AuthorService/UpdateAuthor"
	AuthorService_DeleteAuthor_FullMethodName         = "/api.profile.v1.AuthorService/DeleteAuthor"
)
...
type AuthorServiceClient interface {
	...
	GetAuthorByProfileID(ctx context.Context, in *GetAuthorByProfileIDRequest, opts ...grpc.CallOption) (*GetAuthorByProfileIDResponse, error)
...
func (c *authorServiceClient) GetAuthorByProfileID(ctx context.Context, in *GetAuthorByProfileIDRequest, opts ...grpc.CallOption) (*GetAuthorByProfileIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAuthorByProfileIDResponse)
	err := c.cc.Invoke(ctx, AuthorService_GetAuthorByProfileID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthorServiceServer interface {
	...
	GetAuthorByProfileID(context.Context, *GetAuthorByProfileIDRequest) (*GetAuthorByProfileIDResponse, error)
...
func (UnimplementedAuthorServiceServer) GetAuthorByProfileID(context.Context, *GetAuthorByProfileIDRequest) (*GetAuthorByProfileIDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAuthorByProfileID not implemented")
}
...
func _AuthorService_GetAuthorByProfileID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAuthorByProfileIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthorServiceServer).GetAuthorByProfileID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorService_GetAuthorByProfileID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorServiceServer).GetAuthorByProfileID(ctx, req.(*GetAuthorByProfileIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.profile.v1.AuthorService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAuthorByProfileID",
			Handler:    _AuthorService_GetAuthorByProfileID_Handler,
		},
		{
	...
	Metadata: "profile/v1/author.proto",
}
